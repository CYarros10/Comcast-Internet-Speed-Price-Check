...
def shell():
    ...
    if args.download:
        ...
        downloadSpeed = (results.download / 1000.0 / 1000.0)
        downloadTier = "";

        if (downloadSpeed > 0 and downloadSpeed <= 15):
            downloadTier = "Performance Starter"

        elif (downloadSpeed > 15 and downloadSpeed <= 60):
            downloadTier = "Performance Plus"

        elif (downloadSpeed > 60 and downloadSpeed <= 150):
            downloadTier = "Performance Pro"

        elif (downloadSpeed > 150 and downloadSpeed <= 250):
            downloadTier = "Blast! Pro"

        elif (downloadSpeed > 250 and downloadSpeed <= 1000):
            downloadTier = "Gigabit"

        elif (downloadSpeed > 1000 and downloadSpeed <= 2000):
            downloadTier = "Gigabit Pro"

        print("You should be paying $", wifiTierPrices.get(downloadTier) , " for ", downloadTier, " download speeds")
    ...
    if args.upload:
        ...
        uploadSpeed = (results.upload / 1000.0 / 1000.0)
        uploadTier = "";

        if (uploadSpeed > 0 and uploadSpeed <= 2):
            uploadTier = "Performance Starter"

        elif (uploadSpeed > 2 and uploadSpeed <= 5):
            uploadTier = "Performance Plus"

        # Performance Pro Tier upload speeds are the same as Performance Plus

        elif (uploadSpeed > 5 and uploadSpeed <= 10):
            uploadTier = "Blast! Pro"

        elif (uploadSpeed > 10 and uploadSpeed <= 35):
            uploadTier = "Gigabit"

        elif (uploadSpeed > 35 and uploadSpeed <= 2000):
            uploadTier = "Gigabit Pro"

        print("You should be paying $", wifiTierPrices.get(uploadTier), "for", uploadTier, "upload speeds")
